...
package de.uniulm.omi.cloudiator.visor.monitoring.api;
...
public class InvalidMonitorContextException extends Exception {
    ...
    public InvalidMonitorContextException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
