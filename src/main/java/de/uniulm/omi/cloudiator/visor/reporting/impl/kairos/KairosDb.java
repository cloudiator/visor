...
package de.uniulm.omi.cloudiator.visor.reporting.impl.kairos;
...
import de.uniulm.omi.cloudiator.visor.reporting.impl.MetricReportingException;
...
public class KairosDb implements ReportingInterface<Metric> {
     ...
     * @throws de.uniulm.omi.cloudiator.visor.reporting.impl.MetricReportingException If the kairos server could not be reached.
     */
