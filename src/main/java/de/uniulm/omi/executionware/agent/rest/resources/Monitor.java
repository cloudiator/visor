...
package de.uniulm.omi.executionware.agent.rest.resources;
...
public class Monitor {
    ...
    public static class MonitorBuilder {
        ...
        public MonitorBuilder interval(final de.uniulm.omi.executionware.agent.monitoring.impl.Interval interval) {
