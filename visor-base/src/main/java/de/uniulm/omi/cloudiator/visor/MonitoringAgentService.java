...
public class MonitoringAgentService {
    ...
    public void start() {
        ...
        try {
            injector.getInstance(MonitoringService.class).startMonitoring("cpu_usage", "de.uniulm.omi.cloudiator.visor.monitoring.sensors.CpuUsageSensor", new DefaultInterval(1, TimeUnit.SECONDS), Collections.<String, String>emptyMap());
            injector.getInstance(MonitoringService.class).startMonitoring("memory_usage", "de.uniulm.omi.cloudiator.visor.monitoring.sensors.MemoryUsageSensor", new DefaultInterval(1, TimeUnit.SECONDS), Collections.<String, String>emptyMap());
