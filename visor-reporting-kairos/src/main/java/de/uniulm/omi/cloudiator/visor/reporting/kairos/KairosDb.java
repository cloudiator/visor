...
/**
 * A concrete implementation of the reporting interface, reporting metrics to the kairos database.
 */
public class KairosDb implements ReportingInterface<Metric> {
  ...
  /**
   * Report method for multiple metrics. Converts the metrics to metrics kairos can understand and
   * sends them.
   *
